              ...
              <div className='flex items-center justify-center w-full'>
                 <Tabs className='w-3/4' defaultValue="login">
                   ...
                   <TabsContent className='flex flex-col gap-5 mt-10' value='login'>
                    ...
                    <Button className='rounded-full p-6 bg-black text-white hover:text-black' onClick={handleLogin}>Login</Button>
                   </TabsContent>
                   <TabsContent className='flex flex-col gap-5' value='signup'>
                   <Input placeholder='Email' type="email" className='rounded-full p-6' value={email} onChange={(e)=>setEmail(e.target.value)}/>
                   <Input placeholder='Password' type="password" className='rounded-full p-6' value={password} onChange={(e)=>setPassword(e.target.value)}/>
                   <Input placeholder='Confirm Password' type="password" className='rounded-full p-6' value={ConfirmPassword} onChange={(e)=>setConfirmPassword(e.target.value)}/>
                   <Button className='rounded-full p-6 bg-black text-white hover:text-black' onClick={handleSignup}>Signup</Button>
                   </TabsContent>
                 </Tabs>
              </div>
            </div>
